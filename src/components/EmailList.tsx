...
export const EmailList: React.FC<EmailListProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-white">
      <div className="border-b border-gray-300 p-4 lg:p-6">
        <h1 className="text-xl lg:text-2xl font-bold text-gray-900 glitch-text">
        ...
        {emails.length === 0 ? (
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-base lg:text-lg font-medium">No emails in this folder</p>
              <p className="text-gray-400 text-sm lg:text-base mt-2">Check back later for new startup drama!</p>
            </div>
          </div>
        ) : (
          <div className="divide-y divide-gray-200">
            {emails.map((email) => (
              <div
                ...
                className="p-3 lg:p-4 hover:bg-gray-50 cursor-pointer transition-colors border-l-4 border-transparent hover:border-maxRed group"
              >
